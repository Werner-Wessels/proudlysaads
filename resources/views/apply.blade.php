...
<div class="relative pt-10 pb-20 bg-gray-900">
    ...
    <div class="relative xl:container m-auto px-6 md:px-12 lg:px-6">
        <h1 class="sm:mx-auto sm:w-10/12 md:w-2/3 font-black text-blue-900 text-2xl text-center sm:text-5xl md:text-4xl lg:w-auto lg:text-left xl:text-4xl text-white">Are you an <strong class="text-green-500">Honest</strong>, <strong class="text-green-500">Trustworthy</strong> person?</h1>
        <br>
        <h1 class="sm:mx-auto sm:w-10/12 md:w-2/3 font-black text-blue-900 text-2xl text-center sm:text-5xl md:text-4xl lg:w-auto lg:text-left xl:text-4xl text-white">Do you have <strong class="text-green-500">Basic Computer Literacy</strong>?</h1>

        <br>
        <h1 class="sm:mx-auto sm:w-10/12 md:w-2/3 font-black text-blue-900 text-2xl text-center sm:text-5xl md:text-4xl lg:w-auto lg:text-left xl:text-4xl text-white">Are you a <strong class="text-green-500">Peoples Person</strong>?</h1>

        <br>
        <h1 class="sm:mx-auto sm:w-10/12 md:w-2/3 font-black text-blue-900 text-2xl text-center sm:text-5xl md:text-4xl lg:w-auto lg:text-left xl:text-4xl text-white">Can you <strong class="text-green-500">Sell</strong>?</h1>
        <div class="lg:flex">
            <div class="relative mt-8 md:mt-16 space-y-8 sm:w-10/12 md:w-2/3 lg:ml-0 sm:mx-auto text-center lg:text-left lg:mr-auto lg:w-7/12">
                <p class="sm:text-lg text-gray-300 text-gray-400 lg:w-11/12">
                ...
                <span class="block font-semibold text-gray-300 text-gray-400">What makes this opportunity even more incredible, is that the buying in opportunity will only cost you a R1 000.00</span>
