...
<div class="text-white p-16">
    ...
    <br>
    <br>
    <h1 class="text-xl text-green-500 font-bold underline">Privacy Policy</h1>
    <p>Last updated: December 03, 2022</p>
    ...
    <ul class="list-disc">
        ...
        <li>
            <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Proudly SA Ads, Krugersdrop, Gauteng.</p>
        </li>
        <li>
        ...
        <li>
            <p><strong>Website</strong> refers to Proudly SA Ads, accessible from <a href="https:proudlysaads.co.za" rel="external nofollow noopener" target="_blank">https:proudlysaads.co.za</a></p>
        </li>
        <li>
    ...
    <br>
    <br>
    <h1 class="text-xl text-green-500 font-bold underline">Children's Privacy</h1>
    ...
    <br>
    <br>
    <h1 class="text-xl text-green-500 font-bold underline">Links to Other Websites</h1>
    <p>Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party's site. We strongly advise You to review the Privacy Policy of every site You visit.</p>
    <p>We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</p>

    <br>
    <br>
    <h1 class="text-xl text-green-500 font-bold underline">Changes to this Privacy Policy</h1>
    ...
    <br>
    <br>
    <h1 class="text-xl text-green-500 font-bold underline">Contact Us</h1>
    <p>If you have any questions about this Privacy Policy, You can contact us:</p>
    <ul class="list-disc">
        <li>
            <p>By email: info@proudlysaads.co.za</p>
        </li>
        <li>
            <p>By visiting this page on our website: <a href="https://proudlysaads.co.za/contact" rel="external nofollow noopener" target="_blank">https://proudlysaads.co.za/contact</a></p>
        </li>
    </ul>
</div>
