...
<div class="relative bg-gray-900">
    <div class="relative xl:container m-auto px-6 md:px-12 lg:px-6">
        ...
        <div class="bg-gray-800 border rounded-2xl p-4">
            ...
            <h1 class="sm:mx-auto sm:w-10/12 md:w-2/3  text-lg text-center lg:w-auto text-white">Province: <br class="lg:block hidden"> <span class="relative text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-green-500 from-green-400 to-green-500">{{$user->profile->province ?? null ?: 'Required' }}</span></h1>
