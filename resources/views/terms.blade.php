...
<div class="p-16">
    ...
    <ol class="list-decimal text-white">
        ...
        <li>Please take note that no returns will be accepted on items 3 and 4.</li>
        <li>When an item is secured by placing a bid or order, Proudly SA Ads will see that as a binding acceptance of the before mentioned condition.</li>
        <li>Please therefore make sure you are happy with the condition of the items. No cancellation of an item will be allowed.</li>
    </ol>
    <br>
    <br>
    ...
    <ol class="list-decimal text-white">
        ...
        <li>Please take note that no bids will be able to be placed when payment of previous orders are still outstanding. To avoid accounts from bid suspension, send proof of payment to
            <a href="mail:info@proudlysaads.co.za">info@proudlysaads.co.za</a>.</li>
    </ol>
...
<ol class="text-white list-decimal">
    ...
    <li>If you sell an item on behalf of a third party, ensure that you have the necessary written permission.
        Proudly SA Ads will not be held responsible for any claims that may arise against any vendor/seller.</li>
</ol>
