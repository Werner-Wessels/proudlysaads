...
<nav class="p-5 bg-gray-800 shadow md:flex md:items-center md:justify-between">
    <div class="flex justify-between items-center ">
      <span class="text-2xl font-[Poppins] cursor-pointer">
        <a class=" z-10 " href="/" aria-label="logo">
                        <img class=" max-h-16 md:max-h-24" src="{{ URL::asset('/storage/tickey_logo.svg') }}" alt="" title=""/>
                    </a>
      </span>
    ...
    <ul class="md:flex md:items-center z-[-1] md:z-auto md:static absolute bg-gray-200 p-4 w-full left-0 md:w-auto rounded-lg py-4 md:pl-0 pl-7 md:opacity-100 opacity-0 top-[-400px] transition-all ease-in duration-500">
        ...
        @guest
            ...
            <a href="{{route('user_login')}}"><button class="bg-green-500 m-1 text-white font-[Poppins] duration-500 px-6 py-2 mx-2 hover:bg-green-400 rounded ">
                    Login
                </button></a>
        @endguest
        ...
        @auth
            <a href="{{route('profile.show', Auth::user()->id)}}">
                <button class="bg-green-500 m-1 text-white font-[Poppins] duration-500 px-6 py-2 mx-2 hover:bg-green-400 rounded ">
                    My Account
                </button></a>
            <a href="{{route('logout')}}">
                <button class="bg-green-500 m-1 text-white font-[Poppins] duration-500 px-6 py-2 mx-2 hover:bg-green-400 rounded ">
