            ...
            <div class="flex mt-10 items-center w-full max-w-3xl p-8 mx-auto lg:px-12 lg:w-3/5">
                <div class="w-full">
                    ...
                    <h1 class="text-2xl font-semibold tracking-wider capitalize text-white">
                        Now Showing Results For: <span class="relative text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-green-500 from-green-400 to-green-500">{{$subcategory->name}}</span>
                    </h1>
                </div>
            </div>
        </div>
