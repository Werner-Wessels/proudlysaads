...
<div class="relative pt-10  bg-gray-900">
    <div class="relative xl:container m-auto px-6 md:px-12 lg:px-6">
        <h1 class="sm:mx-auto sm:w-10/12 md:w-2/3 font-black text-blue-900 text-2xl text-center sm:text-5xl md:text-4xl lg:w-auto  xl:text-4xl text-white">Welcome back <strong class="text-green-500">Login</strong> below.</h1>
    </div>
</div>
        ...
        <div class="flex items-center w-full max-w-3xl p-8 mx-auto lg:px-12 lg:w-3/5">
            <div class="w-full">
                <form class="grid grid-cols-1 gap-6 mt-8 md:grid-cols-1" action="{{ route('login.post') }}" method="POST">
                    @csrf
                    <div>
                        <label for="email" class="block mb-2 text-sm text-gray-200 text-gray-200">Email Address</label>
                    ...
                    <div>
                        <label for="password" class="block mb-2 text-sm text-gray-200 text-gray-200">Password</label>
